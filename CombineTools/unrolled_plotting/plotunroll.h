// original author: https://github.com/CMSDASAtLPC/LongExerciseSusyTopTag/blob/master/limit/Plot.h
...
class Plot {
    public:
        ...
        void InitializePaves(){
            ...
            // // Thesis endorsement
            // TLatex width_test_endorsement(0,0,"Private work (CMS data/simulation)");
            // width_test_endorsement.SetTextSize(sizeP/pad1H);
            // double cmsoffset = 0.0;
            // double posP = 1-(marginT-1)/pad1H;
            // double uminCMS = marginL/pad1W * 0.35;
            // double umaxCMS = marginL/pad1W + width_test_endorsement.GetXsize();
            // paveCMS = new TPaveText(uminCMS+cmsoffset,posP,umaxCMS+cmsoffset,1.0,"NDC");
            // paveCMS->SetFillColor(0);
            // paveCMS->SetBorderSize(0);
            // paveCMS->SetTextFont(42);
            // paveCMS->SetTextSize(sizeP/pad1H * 0.9);
            // paveCMS->AddText("Private work (CMS data/simulation)");
            ...
            double cmsoffset = 0.0;
            //double posP = 1-(marginT-1)/pad1H;
            double posP = 0.6;//(marginT-1)/pad1H;
	    std::cout<<"posP "<<posP;
            ...
            paveCMS->SetTextSize((sizeP + 20)/pad1H);
            paveCMS->AddText("CMS");
            ...
            double uminLumi = umaxLumi - (width_test_lumi.GetXsize())-0.04;
	    posP = 1-(marginT-1)/pad1H;
            ...
            //paveLumi->SetTextFont(50);
            paveLumi->SetTextFont(42);
            paveLumi->SetTextSize(1.5*sizeP/pad1H);
        ...
        void FormatHist(TH1* hist){
            ...
            //For NC: 
	    //hist->GetXaxis()->SetLabelSize((sizeL1+20)/pad1H);
            //For cascade: 
	    hist->GetXaxis()->SetLabelSize((sizeL1 + 10)/pad1H);
            hist->GetXaxis()->SetLabelOffset(2.2*offX*sizeLoff/pad1H);
    ...
    private:
        ...
        double sizeT, sizeL, sizeL1, sizeP, sizeTick, sizeLoff, epsilon;
