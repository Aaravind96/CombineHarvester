...
cmsenv
ulimit -s unlimited
cd asymmCards/signal2b2t_new/bdt/; combineCards.py hToA1A2_${signal}_allchannels_2018_${mass1}_${mass2}.txt hToA1A2_${signal}_allchannels_2017_${mass1}_${mass2}.txt hToA1A2_${signal}_allchannels_2016postVFP_${mass1}_${mass2}.txt hToA1A2_${signal}_allchannels_2016preVFP_${mass1}_${mass2}.txt > hToA1A2_${signal}_allchannels_allyears_${mass1}_${mass2}.txt; cd ../../../
text2workspace.py asymmCards/signal2b2t_new/bdt/hToA1A2_${signal}_allchannels_allyears_${mass1}_${mass2}.txt -m ${mass1}
cd condor/
mkdir ${signal}_${mass1}_${mass2}_signal2b2t_new_bdt
cd ${signal}_${mass1}_${mass2}_signal2b2t_new_bdt
combine -M AsymptoticLimits /afs/cern.ch/user/a/aaravind/CMSSW_14_1_0_pre4/src/CombineHarvester/CombineTools/asymmCards/signal2b2t_new/bdt/hToA1A2_${signal}_allchannels_allyears_${mass1}_${mass2}.root --rMin=-10 -m ${mass1} | tee limits_allchannels_${signal}_${mass1}_${mass2}
